    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <?php foreach($caridokter as $dokter) : ?>
                <div class="card-body">
                    <h5 class="card-title"><?= $dokter['Nama']; ?></h5>
                    <h6 class="card-subtitle mb-2 text-muted">NIP <?= $dokter['nip']; ?></h6>
                    <p class="card-text">Telepon : <?= $dokter['No.HP'] ?></p>
                    <p class="card-text">Tempat Praktik Lain : <?= $dokter['Tempat Praktik Lain'] ?></p>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?= base_url(); ?>caridokter" class="btn btn-primary">Kembali</a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
