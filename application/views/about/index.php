...
<div class="card">
  ...
  <div class="card-body">
    <blockquote class="blockquote mb-0">
      <p>Berkah Beauty Clinic adalah sebuah klinik kecantikan yang berdomisili di Malang.
      Memiliki dokter-dokter spesialis kulit terbaik untuk membantu anda merawat kulit anda. Konsultasi dan reservasi online dapat dilakukan
      dengan menghubungi kontak dokter yang tertera. Menyediakan berbagai skincare yang aman dan cocok untuk semua jenis kulit.</p>
      <footer class="blockquote-footer">Best regards <cite title="Source Title">Berkah Beauty Clinic</cite></footer>
    </blockquote>
  </div>
</div>