...
<div class="card list-group-item d-flex justify-content-between align-items-center" style="width: 39,4rem;" >
  <div class="card-body">
    <?php foreach($toko as $produk) : 
      header('Content-type: image')?>
    <h5 class="card-title"><?= $produk['nama']; ?></h5>
    <h6 class="card-subtitle mb-2 text-muted">Rp. <?= $produk['harga']; ?></h6>
    <p class="card-text"><?= $produk['keterangan']; ?></p>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?= base_url(); ?>toko" class="btn btn-outline-primary btn-sm">Kembali</a>
                        <a href="<?= base_url(); ?>belanja/index/" class="btn btn-primary btn-sm">Beli</a>
                    </div>
    <?php endforeach; ?>
  </div>
</div>